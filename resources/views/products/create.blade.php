...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h1 class="ec-page-title">Novo Produto</h1>
    ...
    <div class="row g-4">
            ...
            <div class="ec-card p-4">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" id="preco" name="preco" value="{{ old('preco') }}">
                        @error('preco')
                            <span style="font-size:.8rem;color:#cc0000;margin-top:4px;display:block;">{{ $message }}</span>
                        @enderror
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="ec-card p-4">
                ...
                <a href="{{ route('products.index') }}" class="btn-ec-ghost w-100 justify-content-center" style="width:100%;">
                    Cancelar
                </a>
            </div>
